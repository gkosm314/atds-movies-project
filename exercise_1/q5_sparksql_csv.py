...
res.write.csv("hdfs://master:9000/outputs/q5_sparksql_csv.csv")

end_time = time.time()
with open("query_times.txt", "a") as f:
	f.write("Q5 SparkSQL CSV: " + str(end_time-start_time) + " seconds\n")
	f.write("Q5 SparkSQL CSV (without reading): " + str(end_time-query_time) + " seconds\n")