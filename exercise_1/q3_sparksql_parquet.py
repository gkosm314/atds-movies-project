...
res.write.csv("hdfs://master:9000/outputs/q3_sparksql_parquet.csv")

end_time = time.time()
with open("query_times.txt", "a") as f:
	f.write("Q3 SparkSQL Parquet: " + str(end_time-start_time) + " seconds\n")
	f.write("Q3 SparkSQL Parquet (without reading): " + str(end_time-query_time) + " seconds\n")
